...
export default function Game() {
  ...
  useEffect(() => {
    ...
    setTimeLeft(45); // Reset timer when entering /Game
  ...
  const handleTimerEnd = () => {
    ...
    window.location.href = "https://new-chess-colosseum.vercel.app";
// if (window.location.hostname === 'localhost' && window.location.port === '6960') {
//   // game.playExampleGame().catch(console.error);
// }
  ...
  const handleBet = async () => {
    ...
    if(box1Color!=changeCol && box2Color!=changeCol){
    ...
    if (typeof window.ethereum !== "undefined") {
      try {
        ...
        // Open MetaMask and request account connection
        ...
        const tx = await contract.bet(amountInWei, {
          value: amountInWei,
          gasLimit: ethers.utils.hexlify(300000) // Adjust gas limit if necessary
        });
      ...
      alert("MetaMask is not installed. Please install MetaMask to place a bet.");
    }
  };
  ...
  return (
    ...
    <div className="self-stretch h-[766.76px] w-full justify-start items-start gap-[43.55px] inline-flex">
      ...
      <div className="grow shrink basis-0 h-[670.24px] flex-col justify-start items-start gap-[32.63px] inline-flex overflow-hidden">
        ...
        <div  className="self-stretch h-[367.61px] bg-[url(/chess.png)] bg-cover bg-no-repeat bg-center rounded-[13.44px]" />
      ...
      >
              <div   className={`w-[362.81px] h-[94px]   bg-[#d9d9d9]/5  rounded-[12.47px] flex-col justify-center items-start gap-2.5 flex`}>
                <div className="w-[227.47px] mx-[14px] h-[61.47px] justify-start items-center gap-[15.03px] inline-flex">
                  <div className="w-[61.47px] h-[61.47px]  bg-[url(/3p.png)] bg-cover bg-no-repeat bg-center rounded-full" />
...
<div
      ...
      >
              <div className="w-[362.81px] h-[94px] bg-[#d9d9d9]/5 rounded-[12.47px] flex-col justify-center items-start gap-2.5 flex">
                <div className="w-[227.47px] mx-[14px] h-[61.47px] justify-start items-center gap-[15.03px] inline-flex">
                  <div className="w-[61.47px] h-[61.47px]  bg-[url(/2p.png)] bg-cover bg-no-repeat bg-center rounded-full" />
                  <div className="w-[157.77px] flex-col justify-start items-start gap-[5.63px] inline-flex">
                    <div className="self-stretch text-[#ffffff] text-[16.90px] font-semibold font-['Inter'] capitalize tracking-tight">
                    Shinchan
                    </div>
